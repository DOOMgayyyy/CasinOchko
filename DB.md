...
| deckOfCards | string | (калода карт строкой по default) | номинал карты - 16-ричное число, масть - один из символов: PTGH |
...
| cards | string | номинал карты - 16-ричное число, масть - один из символов: PTGH | формат строки P6TE |
